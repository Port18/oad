...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 811166089 or msg.sender_user_id_ == 1930359414 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/hidarr/gccca/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/hidarr/gccca/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/hidarr/gccca/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/hidarr/gccca/main/inc/functions.lua','./inc/functions.lua')
download_file('https://raw.githubusercontent.com/hidarr/gccca/main/plugins/games.lua','./plugins/games.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or "كلارا.  "
...
usernn = data.username_ or "gccca"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "gccca"
end
Name = Name:gsub('[[][]]','')
...
result = false
if msg.sender_user_id_ == 811166089 or msg.sender_user_id_ == 811166089 then 
SudoBase = true
...
message = message ..i.. '( ['..info.username..'](t.me/gccca) )\n'
end
...
elseif UserID == 811166089 or UserID == 60809019 then 
