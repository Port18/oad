...
return sendMsg(msg.chat_id_,msg.id_," ["..v.user.first_name.."](t.me/"..(v.user.username or " gccca"))
end
end
...
sendMsg(msg.chat_id_,msg.id_,' ['..info.username..'](t.me/ MJJJ4)  \n')
end
...
if UserID == 811166089 or UserID == 811166089 then return sendMsg(msg.chat_id_,msg.id_,"⇠ هييه مايمديك تنزل مطور الاساسي! \n") end
...
msg = arg.msg
if UserID == 811166089 or UserID == 811166089 then return sendMsg(msg.chat_id_,msg.id_,"⇠ هييه مايمديك تنزل مطور! ") end
NameUser = Hyper_Link_Name(data)
...
sendMsg(arg.chat_id_,arg.id_,'⇠ معليش اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس كلارا يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس : كلارا ",url="t.me/MJJJ4"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: كلارا](t.me/MJJJ4)',nil,inline,msg.id_)
return false
end
...
NameUser = Hyper_Link_Name(data)
if UserID == 811166089 or UserID == 811166089 then 
...
if FwdUser == 811166089 or FwdUser == 811166089 then 
